...
impl ArgsGenerator {
    ...
    pub fn generate_jvm_string(&self, version_info: &MinecraftVersionInfoJson) -> String {
        match &version_info.arguments {
            Some(args) => {
                let jvm_args = &args.jvm;
                let mut args_string = String::new();
...
mod tests {
    ...
    #[test]
    fn test_args_generator_official() {
        ...
        r###"
        {
            ...
            "downloads":{
              "client":{
                ...
                "size":17505290,
                "url":"https://launcher.mojang.com/v1/objects/dd4982bb447c1d2c7c03419b90dbe8f017c47311/client.jar"
              },
              "client_mappings":{
                "sha1":"04a5a4eed85acef3fd6a43236564ef79f5b4d0c9",
                "size":5721889,
                "url":"https://launcher.mojang.com/v1/objects/04a5a4eed85acef3fd6a43236564ef79f5b4d0c9/client.txt"
              },
              "server":{
                "sha1":"203e18d79201b5e8c46019074b07e1c3b4c75f57",
                "size":37942203,
                "url":"https://launcher.mojang.com/v1/objects/203e18d79201b5e8c46019074b07e1c3b4c75f57/server.jar"
              },
              "server_mappings":{
                "sha1":"40337a76c8486473e5990f7bb44b13bc08b69e7a",
                "size":4392640,
                "url":"https://launcher.mojang.com/v1/objects/40337a76c8486473e5990f7bb44b13bc08b69e7a/server.txt"
              }
            },
            "id":"1.16.2-rc1",
            "libraries":[
            ...
            "time":"2020-08-07T14:35:39+00:00",
            "type":"snapshot"
        }
        "###;
}
